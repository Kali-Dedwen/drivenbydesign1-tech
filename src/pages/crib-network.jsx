...
const styles = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  :root{--navy:#0A1628;--navy-mid:#0D2045;--gold:#C9A84C;--gold-muted:#9E7E38;--bridge:#1D9E75;--bridge-light:rgba(29,158,117,0.12);--white:#FFFFFF;--white-soft:#E8EDF5;--white-dim:#A0AEC0;--font-display:'Cormorant Garamond',Georgia,serif;--font-body:'DM Sans',system-ui,sans-serif;--font-mono:'JetBrains Mono',monospace;}
  ...
  .nav{position:fixed;top:0;left:0;right:0;z-index:100;height:72px;display:flex;align-items:center;justify-content:space-between;padding:0 clamp(1.5rem,5vw,4rem);background:rgba(10,22,40,0.92);backdrop-filter:blur(12px);border-bottom:1px solid rgba(29,158,117,0.15);}
  ...
  .hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 55% 55% at 65% 45%,rgba(29,158,117,0.08),transparent);pointer-events:none;}
  ...
  .stats-card{background:linear-gradient(145deg,#0D2045,#1A3560);border:1px solid rgba(29,158,117,0.25);border-radius:14px;padding:2rem;}
  ...
  .service-card{background:var(--bridge-light);border:1px solid rgba(29,158,117,0.2);border-radius:12px;padding:1.5rem;}
  ...
  .divider{width:100%;height:1px;background:linear-gradient(to right,transparent,rgba(29,158,117,0.2),transparent);}
  .m2m-badge{text-align:center;padding:2.5rem;background:#060F1E;border-top:1px solid rgba(29,158,117,0.12);}
