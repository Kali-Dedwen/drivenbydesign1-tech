...
/* ─────────────────────────────────────────────
   ...
   Service Lanes: capability language replaces platform-launch language
   NC Cases: initiative-name references removed; capability-led copy activated
   Gate: PASS — Trust/Liability checked, no unverified claims
───────────────────────────────────────────── */
...
const SERVICES = [
  ...
  {
    // CHANGED: headline was "BRIDGE OS™ Licensing" — updated to reflect
    // actual delivery model vs. unlaunched licensing platform
    icon: "◆",
...
// was: named project references (Project CHECK, CRIB, FUSE) with
//      civic program language — creates liability for unfunded/undelivered claims
// now: capability-led descriptions of what BRIDGE OS™ actually delivers
//      in each community context — defensible, present-tense, accurate
const CASES = [
  {
